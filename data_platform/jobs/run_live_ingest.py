...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--window-start", default=os.getenv("LIVE_INGEST_WINDOW_START", "00:00"))
    parser.add_argument("--window-end", default=os.getenv("LIVE_INGEST_WINDOW_END", "00:00"))
