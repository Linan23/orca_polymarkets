"""Compare Random Forest and LightGBM on the grouped market outcome split."""
...
from data_platform.ml.market_baseline_model import (
    DEFAULT_MODEL_FAMILY_COMPARISON_PATH,
...
def parse_args() -> argparse.Namespace:
    """Parse CLI arguments."""
    parser = argparse.ArgumentParser(description="Compare Random Forest and LightGBM on the grouped market split.")
    parser.add_argument(
        "--dataset-path",
...
def main() -> int:
    """CLI entrypoint."""
    args = parse_args()
    result = compare_market_model_families(
