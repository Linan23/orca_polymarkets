"""Compare LightGBM price-only and price-plus-whale market models on the same grouped split."""
...
from data_platform.ml.market_baseline_model import (
    DEFAULT_LIGHTGBM_FEATURE_SET_COMPARISON_PATH,
    compare_price_vs_whale_market_models_lightgbm,
)
...
def parse_args() -> argparse.Namespace:
    """Parse CLI arguments."""
    parser = argparse.ArgumentParser(description="Compare LightGBM market feature sets on the grouped time split.")
    parser.add_argument(
        "--dataset-path",
    ...
    parser.add_argument(
        "--comparison-path",
        default=str(DEFAULT_LIGHTGBM_FEATURE_SET_COMPARISON_PATH),
